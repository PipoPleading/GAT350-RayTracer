...
template <typename T>
inline T lerp(const T& a, const T& b, float t) { return a + t * (b - a); }
...
inline float dot(glm::vec3& v1, glm::vec3& v2){
...
inline bool approximately(float value1, float value2)
{
    ...
    return ((fabs(value1 - value2)) < FLT_EPSILON);//(get floating - point absolute value(subtract value 1 from value 2) < FLT_EPSILON);
...
// REFRACTION INDEX FOR LATER USE
//Vacuum: 1.0
//Air : 1.0003
//Water : 1.333
//Ice : 1.309
